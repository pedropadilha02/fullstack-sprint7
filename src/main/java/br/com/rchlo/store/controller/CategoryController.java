...
public class CategoryController {
    ...
    public ResponseEntity<Void> create(@RequestBody @Valid CategoryForm categoryDto, UriComponentsBuilder uriBuilder) {
        Category category = categoryRepository.save(categoryDto.convert(categoryRepository::maxPosition));
